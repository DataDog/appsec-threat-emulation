...
async function bruteforce(targetURL){
    ...
    const spinner = ora('Running basic bruteforce attack').start();
    ...
    spinner.stopAndPersist({
        symbol: logSymbols.success,
        text: 'Bruteforce attack - done',
    });
}

module.exports = { credentialStuffing, bruteforce}